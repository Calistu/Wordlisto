char entradas()
{
    ...
    fgets(pet, 20, stdin);
    limpacr(pet);
    printf("\nTYPE A OWNER PASSWORD PHONE NUMBER\nRECOMMEND THIS DEFAULT (7 caracters)  XXXXXXX: ");
    fgets(numero, 10, stdin);
    limpacr(numero);
    sprintf(pparte, "%c%c%c", numero[0], numero[1], numero[2]);
    sprintf(sparte, "%c%c%c", numero[4], numero[5], numero[6],numero[7]);
    sprintf(nnumero, "9%s", numero);
    printf("\nTYPE A OWNER PASSWORD OLD PHONE\nRECOMMEND THIS DEFAULT (7 caracters) XXXXXXX: ");
    fgets(numero2, 10, stdin);
    limpacr(numero2);
    sprintf(pparte2, "%c%c%c", numero2[0], numero2[1], numero2[2]);
    sprintf(sparte2, "%c%c%c", numero2[4], numero2[5], numero2[6],numero[7]);
